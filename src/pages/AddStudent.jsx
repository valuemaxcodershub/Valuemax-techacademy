      ...
      <div className="flex min-h-screen">
        <div className="flex justify-between w-full">
          ...
          <main
            className={
              darkMode
                ? "bg-admin-dark text-white grow p-2 lg:p-6 flex justify-center items-center"
                : "bg-admin-light text-white grow p-2 lg:p-6 flex justify-center items-center"
            }
          >
            <form
              onSubmit={handleSubmit}
              className= { darkMode ? "space-y-4 bg-slate-800 rounded-2xl grow max-w-[360px] py-4 px-5 md:max-w-[560px]" : "space-y-4 bg-slate-600 text-white rounded-2xl grow max-w-[360px] py-4 px-5 md:max-w-[560px]"}
            >
              ...
              <button
                type="submit"
                className={darkMode ? "mt-4 w-full bg-slate-600 text-white py-2 px-4 rounded-md shadow-sm hover:bg-slate-700 focus:outline-none focus:ring-2 focus:ring-slate-500 focus:ring-offset-2" : "mt-4 w-full bg-slate-700 text-white py-2 px-4 rounded-md shadow-sm hover:bg-slate-800 focus:outline-none focus:ring-2 focus:ring-slate-500 focus:ring-offset-2"}
              >
                Submit
              </button>
            </form>
